...
public abstract class CFiniteStateMachineUnitSkillBase : CFiniteStateMachineBase
{
    ...
    //--------------------------------------------------------
    protected override sealed void ProtStateAction(CStateBase pState, EStateEnterType eStateAction) { base.ProtStateAction(pState, eStateAction); }
    protected override sealed void ProtStateLeave(CStateBase pState) { base.ProtStateLeave(pState);}
}

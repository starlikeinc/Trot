...
// [주의] 상속받는 DBSheet는 맴버로 int / uint / float / bool / string 만 가져야 한다. 
...
public abstract class CGameDBSheetBase
{
	...
	//----------------------------------------------------------------------------
    internal void InterGameDBSheetRefresh()  // 보안 필드에서 메모리 캐쉬로 이동할때 
    {
        OnGameDBSheetRefresh();
    }

    internal void InterGameDBSheetLocalDB()
    {
        OnGameDBSheetLocalDB();
    }

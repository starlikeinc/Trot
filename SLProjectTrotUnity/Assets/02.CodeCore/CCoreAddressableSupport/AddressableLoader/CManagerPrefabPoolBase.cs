...
{   
    ...
    private void RemoveInternal(SPrefabPool pRemovePool, bool bOnlyRemovePrefab)
	{
		...
		{
			OnPrefabOriginRemove(pRemovePool.AddressableName, pRemovePool.OriginHandle);
	...
	protected virtual void OnPrefabOriginRemove(string _addressableName, AsyncOperationHandle pRemovedHandle) { } // 원본이 해재 되었기 때문에 다음 Unloadunused에서 비디오 메모리가 내려간다. 
